...
const branch = process.argv.length < 5 ? await getCurrentBranch(repoDir) : process.argv[3]
const outFileName = process.argv.length < 4 ? `./.temp/${getRepoName(repoDir)}_${branch}.json` : process.argv[3]
