...
import { setExtensionColor } from "./fileExtension.ts"
import { setDominanceColor } from "./singleAuthor.ts"
import { CommitAmountTranslater } from "./mostCommits.ts"
import { getLastChangedIndex, lastChangedGroupings } from "./lastChanged.ts"
import { setDominantAuthorColor } from "./topContributer.ts"
import { TruckFactorTranslater } from "./truckFactor.ts"
