...
import type { HydratedGitTreeObject, HydratedGitBlobObject, GitObject } from "./analyzer/model"
...
export const isTree = (d: GitObject | null = null): d is HydratedGitTreeObject => d?.type === "tree"
export const isBlob = (d: GitObject | null = null): d is HydratedGitBlobObject => d?.type === "blob"
